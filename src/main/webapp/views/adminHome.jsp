	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link" href="/adminhome">Домашняя 
							Страница</a></li>
					<li class="nav-item active"><a class="nav-link" href="/logout">Выход из системы</a></li>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Управляйте всеми клиентами здесь.</p>
						<a href="/admin/customers" class="card-link btn btn-primary">Управлять</a>
