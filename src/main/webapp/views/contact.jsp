        ...
        <h4>Добро пожаловать ${ username } </h4>
            ...
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" th:href="@{/}" href="#">Главная страница</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" th:href="@{/shop}" href="#">Магазин</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" sec:authorize="isAuthenticated()" href="logout">Выход из системы</a>
                </li>
                <li class="nav-item active">
...
<header>
	<div class="overlay">
<center><h2>заполните эту форму для поставщика</h2></center>
<style>
h2 {
            ...
            <tr>
                <td align="center" colspan="2">
                    <br><button type="submit">
                        <font size="5" face="arial">отправить сообщение</font>
                    </button>
                </td>
            </tr>
            <tr>
