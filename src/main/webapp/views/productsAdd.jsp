			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control border border-warning" required name="name" placeholder="Введите имя">
					</div>
					...
					<div class="form-group">
						...
						<input type="number" class="form-control border border-warning" required name="weight" min="1" placeholder="Вес">
					</div>
					<div class="form-group">
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-warning" rows="4" name="description" placeholder="Подробная информация о продукте" value= "no product details"></textarea>
					</div>
					...
					<div class="custom-file">
						...
						<label class="custom-file-label border border-warning" for="productImage">Выберите файл</label>
