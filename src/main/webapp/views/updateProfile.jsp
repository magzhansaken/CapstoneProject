    ...
    <div class="col-sm-6">
        ...
        <form action="updateuser" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control form-control-lg" required placeholder="Пароль*" value="${password }" required name="password"
                       ...
                       <input type="checkbox" onclick="showPassword()">Показать пароль
            </div>
            <div class="form-group">
                <label for="Address">Адрес</label>
                <textarea class="form-control form-control-lg" rows="3" placeholder="Введите свой адрес" name="address">${address }</textarea>
            </div>
