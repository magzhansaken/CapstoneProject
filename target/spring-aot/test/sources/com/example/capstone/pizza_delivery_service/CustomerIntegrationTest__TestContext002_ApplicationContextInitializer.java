 ...
 */
public class CustomerIntegrationTest__TestContext002_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CustomerIntegrationTest__TestContext002_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CustomerIntegrationTest__TestContext002_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.example.capstone.pizza_delivery_service.security.WebSecurityConfig");
