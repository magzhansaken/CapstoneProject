 ...
 */
public class AuthController__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getAuthControllerBeanDefinition1() {
    Class<?> beanType = AuthController.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(AuthController__TestContext002_BeanDefinitions::getAuthControllerScopedProxyInstance));
    return beanDefinition;
  }
}
