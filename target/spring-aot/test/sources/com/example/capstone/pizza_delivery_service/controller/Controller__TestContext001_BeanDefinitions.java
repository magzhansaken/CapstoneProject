 ...
 */
public class Controller__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getControllerBeanDefinition1() {
    Class<?> beanType = Controller.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(Controller__TestContext001_BeanDefinitions::getControllerScopedProxyInstance));
    return beanDefinition;
  }
}
