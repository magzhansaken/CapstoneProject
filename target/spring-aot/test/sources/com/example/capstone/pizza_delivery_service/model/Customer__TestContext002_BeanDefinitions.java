 ...
 */
public class Customer__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getCustomerBeanDefinition1() {
    Class<?> beanType = Customer.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(Customer__TestContext002_BeanDefinitions::getCustomerScopedProxyInstance));
    return beanDefinition;
  }
}
