 ...
 */
public class Dishes__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getDishesBeanDefinition1() {
    Class<?> beanType = Dishes.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(Dishes__TestContext002_BeanDefinitions::getDishesScopedProxyInstance));
    return beanDefinition;
  }
}
