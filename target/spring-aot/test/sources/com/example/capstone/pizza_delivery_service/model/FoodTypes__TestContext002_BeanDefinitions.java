 ...
 */
public class FoodTypes__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getFoodTypesBeanDefinition1() {
    Class<?> beanType = FoodTypes.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(FoodTypes__TestContext002_BeanDefinitions::getFoodTypesScopedProxyInstance));
    return beanDefinition;
  }
}
