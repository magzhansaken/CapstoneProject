 ...
 */
public class OrderCart__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getOrderCartBeanDefinition1() {
    Class<?> beanType = OrderCart.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(OrderCart__TestContext001_BeanDefinitions::getOrderCartScopedProxyInstance));
    return beanDefinition;
  }
}
