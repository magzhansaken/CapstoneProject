 ...
 */
public class OrderDetails__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getOrderDetailsBeanDefinition1() {
    Class<?> beanType = OrderDetails.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(InstanceSupplier.of(OrderDetails__TestContext002_BeanDefinitions::getOrderDetailsScopedProxyInstance));
    return beanDefinition;
  }
}
