...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext002_Autowiring8;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link CustomersRepository}.
 */
public class CustomersRepository__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getCustomersRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext002_Autowiring8::apply);
