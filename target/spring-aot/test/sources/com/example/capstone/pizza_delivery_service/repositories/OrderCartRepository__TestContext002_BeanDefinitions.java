...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext002_Autowiring6;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link OrderCartRepository}.
 */
public class OrderCartRepository__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getOrderCartRepositoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext002_Autowiring6::apply);
