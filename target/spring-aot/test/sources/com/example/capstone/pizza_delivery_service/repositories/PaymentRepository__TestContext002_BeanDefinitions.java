 ...
 */
public class PaymentRepository__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getPaymentRepositoryBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, PaymentRepository.class, Object.class, Object.class);
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.capstone.pizza_delivery_service.repositories.PaymentRepository");
