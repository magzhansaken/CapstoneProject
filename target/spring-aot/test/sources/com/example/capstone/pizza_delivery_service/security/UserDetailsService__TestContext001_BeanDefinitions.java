 ...
 */
public class UserDetailsService__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getUserDetailsServiceBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(UserDetailsService__TestContext001_Autowiring::apply);
