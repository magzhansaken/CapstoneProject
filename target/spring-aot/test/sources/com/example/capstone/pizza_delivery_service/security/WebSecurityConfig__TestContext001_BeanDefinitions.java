 ...
 */
public class WebSecurityConfig__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getDetailsServiceBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(UserDetailsService__TestContext001_Autowiring1::apply);
