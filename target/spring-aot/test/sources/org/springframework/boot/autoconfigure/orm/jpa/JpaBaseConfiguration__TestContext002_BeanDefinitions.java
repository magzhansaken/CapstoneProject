...
public class JpaBaseConfiguration__TestContext002_BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.capstone.pizza_delivery_service.entity.AuthGroupEntity", "com.example.capstone.pizza_delivery_service.entity.CustomerEntity", "com.example.capstone.pizza_delivery_service.entity.CustomersCredentialsEntity", "com.example.capstone.pizza_delivery_service.entity.DishesEntity", "com.example.capstone.pizza_delivery_service.entity.FoodTypesEntity", "com.example.capstone.pizza_delivery_service.entity.OrderCartEntity", "com.example.capstone.pizza_delivery_service.entity.OrderDetailsEntity", "com.example.capstone.pizza_delivery_service.entity.OrdersEntity", "com.example.capstone.pizza_delivery_service.entity.PaymentEntity", "com.example.capstone.pizza_delivery_service.entity.ToppingsEntity");
